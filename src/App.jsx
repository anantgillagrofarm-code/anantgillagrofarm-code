...
/*
  ...
  Public assets that are used by path:
    public/anant_gill_logo.png
    public/footer-mushrooms-v2.jpg
    public/bg-mushrooms.jpg
*/
...
const PRODUCTS = [
  {
    ...
    image: imgFresh,
    variants: [
      { id: "box200", label: "1 box (200 g)", price: 30 },
...
function App() {
  ...
  useEffect(() => {
    ...
    if (sheetProduct) document.body.classList.add("no-scroll");
  ...
  function handleAdd(product, variantId = null, qty = 1) {
    ...
    setMiniVisible(true);
    // small timeout to keep mini visible for a bit
      ...
      <footer className="site-footer" role="contentinfo">
        <div className="footer-inner">
          ...
          <div className="footer-right">
            ...
            <div style={{ color: "rgba(255,255,255,0.95)", marginTop: 12 }}>© {new Date().getFullYear()} Anant Gill Agro Farm</div>
          </div>
        </div>
      </footer>
